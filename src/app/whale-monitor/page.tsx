        ...
        <main className="container mx-auto px-4 py-6 sm:py-8">
          ...
          {isLoading ? (
            ...
            <>
              ...
              {/* ========== SECTION 2: 온체인 분석 (토큰 공급, 홀더 분포, 고래 활동) ========== */}
              {activeSection === 'all' && (
                <div className="mb-8">
                  <OnChainAnalysis
                    data={{
                      ...
                      holdersData: {
                        total: 1812961,
                        topHolders: [
                          { address: '0x0000...dead', shortAddress: '0x00...dead', balanceFormatted: 150000000, percentage: 18.9 },
                          { address: '0x7a25...3f21', shortAddress: '0x7a...3f21', balanceFormatted: 85000000, percentage: 10.7 },
                          { address: '0x3d8b...9e42', shortAddress: '0x3d...9e42', balanceFormatted: 42000000, percentage: 5.3 },
                          { address: '0x9f1c...2a7d', shortAddress: '0x9f...2a7d', balanceFormatted: 28000000, percentage: 3.5 },
                          { address: '0x5e4a...8c3b', shortAddress: '0x5e...8c3b', balanceFormatted: 21000000, percentage: 2.7 },
                        ],
                        isEstimated: true,
                      },
                      whaleTransactions: transactions.slice(0, 10).map(tx => ({
                        txHash: tx.hash,
                        ...
                        priceAtTrade: lgnsPrice,
                        priceImpact: (tx.amountUSD / 1000000) * 0.1,
